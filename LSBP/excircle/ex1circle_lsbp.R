...
save.image("excircle_lsbp.RData")
...
png("excircle_lsbp_fpred.png",width = 500, height = 450)
cols = rainbow(6)
ggplot() +
...
png("excircle_lsbp_dens_heat",width = 500, height = 450)
...
coeff = max(l1_dist)
png("excircle_lsbp_l1dist",width = 500, height = 500)
ggplot() +
