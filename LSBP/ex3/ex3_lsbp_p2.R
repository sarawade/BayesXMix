...
prior       <- prior_LSBP(p_kernel = p+1,p_mixing = p+1, 
                          b_mixing =rep(0,p+1), B_mixing=diag(c(rep(10^4,p+1))), 
...
#Heat map of mean
png("ex3_lsbp_pred_heat_p2.png",width = 500, height = 450)
...
png("ex3_lsbp_pred_p2.png",width = 500, height = 450)
xnew2 = 1.5
ggplot() +
...
png("ex3_lsbp_fpred_p2.png",width = 500, height = 450)
cols = rainbow(6)
ggplot() +
...
#Heat map of l1 dist
png("ex3_lsbp_l1_heat_p2.png",width = 500, height = 450)
