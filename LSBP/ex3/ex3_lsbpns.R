...
#Heat map of mean
png("ex3_lsbpns_pred_heat.png",width = 500, height = 450)
...
png("ex3_lsbpns_pred.png",width = 500, height = 450)
xnew2 = 1.5
ggplot() +
...
png("ex3_lsbpns_fpred.png",width = 500, height = 450)
cols = rainbow(6)
ggplot() +
...
#Heat map of l1 dist
png("ex3_lsbpns_l1_heat.png",width = 500, height = 450)
