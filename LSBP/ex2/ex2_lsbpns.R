...
png("ex2_lsbpns_pred.png",width = 500, height = 450)
ggplot() +
...
#PLot density for a few observations
png("ex2_lsbpns_fpred.png",width = 500, height = 450)
cols = rainbow(6)
ggplot() +
...
png("ex2_lsbpns_dens_heat",width = 500, height = 450)
...
coeff = max(l1_dist)
png("ex2_lsbpns_l1dist",width = 500, height = 500)
ggplot() +
