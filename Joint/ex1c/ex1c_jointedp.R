...
save.image("ex1_jointEDP_mm.RData")
...
png("ex1_jedp_clus_mmerrors.png",width = 500, height = 450)
ggplot() +
...
png("ex1_jedp_pred_mmerrors.png",width = 500, height = 450)
ggplot() +
...
png("ex1_jedp_fpred_mmerrors.png",width = 500, height = 450)
cols = rainbow(6)
ggplot() +
