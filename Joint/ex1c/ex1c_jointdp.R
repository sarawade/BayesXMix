...
setwd("/Users/swade/Documents/GitHub/BayesXMix/Joint/ex1c")
...
save.image("ex1_jointDP_mm.RData")
...
png("ex1_jdp_clus1_mmerrors.png",width = 500, height = 450)
ggplot() +
  geom_point(aes(x = x[,1], y = x[,2], color = as.factor(output_vi$cl))) +
  theme_bw() +
  labs( x = "x_1", y = "x_2", color = "Cluster")
dev.off()
png("ex1_jdp_clus2_mmerrors.png",width = 500, height = 450)
ggplot() +
...
png("ex1_jdp_pred_mmerrors.png",width = 500, height = 450)
ggplot() +
...
png("ex1_jdp_fpred_mmerrors.png",width = 500, height = 450)
cols = rainbow(6)
ggplot() +
