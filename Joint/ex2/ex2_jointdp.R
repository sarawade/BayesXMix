...
png("ex2_jdp_clus.png",width = 500, height = 450)
ggplot() +
...
png("ex2_jdp_pred.png",width = 500, height = 450)
ggplot() +
...
png("ex2_jdp_fpred.png",width = 500, height = 450)
cols = rainbow(6)
ggplot() +
...
png("ex2_jdp_dens_heat",width = 500, height = 450)
...
coeff = max(l1_dist)
png("ex2_jdp_l1dist",width = 500, height = 500)
ggplot() +
