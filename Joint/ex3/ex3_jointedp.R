...
png("ex3_jedp_clus.png",width = 500, height = 450)
ggplot() +
...
#Heat map of mean
png("ex3_jedp_pred_heat.png",width = 500, height = 450)
...
png("ex3_jedp_pred.png",width = 500, height = 450)
xnew2 = 1.5
ggplot() +
...
png("ex3_jedp_fpred.png",width = 500, height = 450)
cols = rainbow(6)
ggplot() +
...
#Heat map of mean
png("ex3_jedp_l1_heat.png",width = 500, height = 450)
