...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%mcmc=[2000,1,2000];
save 'example2_nwreg_v3'

csvwrite('ex2_pred_nwreg_v3.csv',[Y_pred,Y_pred_CI(:,1:2)]);
csvwrite('ex2_fpred_nwreg_v3.csv',Y_fpred);
csvwrite('ex2_lfpred_nwreg_v3.csv',l_fpred);
csvwrite('ex2_ufpred_nwreg_v3.csv',u_fpred);
csvwrite('ex2_config_nwreg_v3.csv',d);
