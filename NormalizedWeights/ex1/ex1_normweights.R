...
setwd("/Users/swade/Documents/GitHub/BayesXMix/NormalizedWeights/ex1")
...
config=as.matrix(read.csv("ex1_config_nwreg.csv", header = FALSE))
S = dim(config)[1]
k=rep(0,S)
for(s in 1:S){
...
png("ex1_nw_clus.png",width = 500, height = 450)
ggplot() +
...
png("ex1_nw_pred.png",width = 500, height = 450)
ggplot() +
...
png("ex1_nw_fpred.png",width = 500, height = 450)
cols = rainbow(6)
ggplot() +
