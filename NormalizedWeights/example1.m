...
x_new=csvread('ex1test_v2.csv',1,1);
n_new=size(x_new,1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%mcmc=[2000,1,2000];
save 'example1_nwreg_v2'

csvwrite('ex1_pred_nwreg_v2.csv',[Y_pred,Y_pred_CI(:,1:2)]);
csvwrite('ex1_fpred_nwreg_v2.csv',Y_fpred);
csvwrite('ex1_config_nwreg_v2.csv',d);
csvwrite('ex1_lfpred_nwreg_v2.csv',l_fpred);
csvwrite('ex1_ufpred_nwreg_v2.csv',u_fpred);
