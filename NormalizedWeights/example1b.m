...
M=csvread('ex1train_skewerrors.csv',1,1);
Y=M(:,3);
x=M(:,1:2);
...
x_new=csvread('ex1test_skewerrors.csv',1,1);
n_new=size(x_new,1);
...
Y_fpred_true = csvread('ex1test_skewerrors_dens.csv',1,1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%mcmc=[2000,1,2000];
save 'example1_nwreg_skewerrors'

csvwrite('ex1_pred_nwreg_skewerrors.csv',[Y_pred,Y_pred_CI(:,1:2)]);
csvwrite('ex1_fpred_nwreg_skewerrors.csv',Y_fpred);
csvwrite('ex1_config_nwreg_skewerrors.csv',d);
csvwrite('ex1_lfpred_nwreg_skewerrors.csv',l_fpred);
csvwrite('ex1_ufpred_nwreg_skewerrors.csv',u_fpred);
