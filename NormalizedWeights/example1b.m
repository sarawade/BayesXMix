%% EXAMPLE %%
% Example 1b from Wade and Inacio (2024): extending example 1 with skew
% normal errors
...
M=csvread('ex1b/ex1train_skewerrors.csv',1,1);
Y=M(:,3);
x=M(:,1:2);
...
x_new=csvread('ex1b/ex1test_skewerrors.csv',1,1);
n_new=size(x_new,1);
...
% comparison with estimates
Y_fpred_true = csvread('ex1b/ex1test_skewerrors_dens.csv',1,1);
...
%% SAVE WORKSPACE %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
save 'ex1b/example1_nwreg_skewerrors'

csvwrite('ex1b/ex1_pred_nwreg_skewerrors.csv',[Y_pred,Y_pred_CI(:,1:2)]);
csvwrite('ex1b/ex1_fpred_nwreg_skewerrors.csv',Y_fpred);
csvwrite('ex1b/ex1_config_nwreg_skewerrors.csv',d);
csvwrite('ex1b/ex1_lfpred_nwreg_skewerrors.csv',l_fpred);
csvwrite('ex1b/ex1_ufpred_nwreg_skewerrors.csv',u_fpred);
