...
save 'ex3/example3_nwreg'

csvwrite('ex3/ex3_pred_nwreg.csv',[Y_pred,Y_pred_CI(:,1:2)]);
csvwrite('ex3/ex3_fpred_nwreg.csv',Y_fpred);
csvwrite('ex3/ex3_config_nwreg.csv',d);
csvwrite('ex3/ex3_lfpred_nwreg.csv',l_fpred);
csvwrite('ex3/ex3_ufpred_nwreg.csv',u_fpred);
