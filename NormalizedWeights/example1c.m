%% EXAMPLE %%
% Example 1c from Wade and Inacio (2024): extending example 1 with bimodal
% errors
...
M=csvread('ex1c/ex1train_mmerrors.csv',1,1);
Y=M(:,3);
x=M(:,1:2);
...
x_new=csvread('ex1c/ex1test_mmerrors.csv',1,1);
n_new=size(x_new,1);
...
% comparison with estimates
Y_fpred_true = csvread('ex1c/ex1test_mmerrors_dens.csv',1,1);
...
%% SAVE WORKSPACE %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
save 'ex1c/example1_nwreg_mmewerrors'

csvwrite('ex1c/ex1_pred_nwreg_mmerrors.csv',[Y_pred,Y_pred_CI(:,1:2)]);
csvwrite('ex1c/ex1_fpred_nwreg_mmerrors.csv',Y_fpred);
csvwrite('ex1c/ex1_config_nwreg_mmerrors.csv',d);
csvwrite('ex1c/ex1_lfpred_nwreg_mmerrors.csv',l_fpred);
csvwrite('ex1c/ex1_ufpred_nwreg_mmerrors.csv',u_fpred);
