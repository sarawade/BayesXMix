...
M=csvread('ex1train_terrors.csv',1,1);
Y=M(:,3);
x=M(:,1:2);
...
x_new=csvread('ex1test_terrors.csv',1,1);
n_new=size(x_new,1);
...
Y_fpred_true = csvread('ex1test_terrors_dens.csv',1,1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%mcmc=[2000,1,2000];
save 'example1_nwreg_terrors'

csvwrite('ex1_pred_nwreg_terrors.csv',[Y_pred,Y_pred_CI(:,1:2)]);
csvwrite('ex1_fpred_nwreg_terrors.csv',Y_fpred);
csvwrite('ex1_config_nwreg_terrors.csv',d);
csvwrite('ex1_lfpred_nwreg_terrors.csv',l_fpred);
csvwrite('ex1_ufpred_nwreg_terrors.csv',u_fpred);
