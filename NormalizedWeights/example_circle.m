...
M=csvread('extrain_circle.csv',1,1);
Y=M(:,2);
x=M(:,1);
% Sample size
n=size(Y,1);
...
x_new=csvread('extest_circle.csv',1,1);
n_new=size(x_new,1);
...
Y_fpred_true = csvread('extest_circle_dens.csv',1,1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%mcmc=[2000,1,2000];
save 'example_nwreg_circle'

csvwrite('ex_pred_nwreg_circle.csv',[Y_pred,Y_pred_CI(:,1:2)]);
csvwrite('ex_fpred_nwreg_circle.csv',Y_fpred);
csvwrite('ex_config_nwreg_circle.csv',d);
csvwrite('ex_lfpred_nwreg_circle.csv',l_fpred);
csvwrite('ex_ufpred_nwreg_circle.csv',u_fpred);
